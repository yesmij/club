...
public class PackageDependencyTests {
    ...
    @ArchTest
    ArchRule modulesPackageRule = classes().that().resideInAPackage("com.nagesoft.club.modules..")
            .should().onlyBeAccessed().byClassesThat()
            .resideInAnyPackage("com.nagesoft.club.modules..");
    ...
    @ArchTest
    ArchRule cycleCheck = slices().matching("com.nagesoft.club.modules.(*)..")
